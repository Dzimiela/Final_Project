...
def test_allocating_to_a_batch_reduces_the_available_quantity():
    batch = Batch("batch-001", "SMALL-TABLE", distance=20, eta=date.today())
...
def make_batch_and_line(road, batch_distance, line_distance):
    return (
        Batch("batch-001", road, batch_distance, eta=date.today()),
...
def test_cannot_allocate_if_roads_do_not_match():
    ...
    assert batch.can_allocate(different_road_line) is False
